...
Tò mò không biết đầu ra trông thế nào? Clip dưới đây được **pipeline render trọn vẹn** — giọng đọc
tiếng Việt, template poster động và hiệu ứng âm thanh tự ghép — tất cả chỉ từ một câu lệnh, không
hề chỉnh tay. Đây là output thô, đúng y như công cụ xuất ra.

<div align="center">

<video src="./assets/claudecode_aicoding.mp4" controls muted playsinline width="304" height="540"></video>

<sub>▶️ Video không tự phát? <a href="./assets/claudecode_aicoding.mp4">Mở video mẫu</a></sub>
